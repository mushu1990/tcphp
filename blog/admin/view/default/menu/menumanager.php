...
<script type="text/javascript">
    ...
    addMenu:function(){
        ...
        $("#dialog_1").dialog({
            ...
            height: '270',
            iconCls: 'icon-add',
            href: '/tcphp/index.php/admin/menu/addmenu/menuid/'+menu_id,
            modal: true
        });
    ...
    $('#menus').treegrid({
    title:'菜单管理',
    url:'/tcphp/index.php/admin/menu/menulists',
    idField:'menuid',
    treeField:'name',
    columns:[[
        {field:'menuid',title:'菜单id',align:'center',width:20},
        {field:'name',title:'菜单名称',align:'left',width:100},
        {field:'url',title:'菜单规则',align:'center',width:200},
        {field:'display',title:'是否显示',width:50},
        {field:'tip',title:'菜单描述',align:'center',width:200}
            ],],
    toolbar: [{
        iconCls: 'icon-add',
